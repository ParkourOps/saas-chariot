...
<template>
    <details class="dropdown" ref="dropdown">
        ...
        <ul class="dropdown-content z-[1] card card-compact rounded-t-none shadow bg-base-100 w-full">
            ...
            <div class="max-h-[350px] overflow-y-auto">
                <li 
                    ...
                    class="py-2 px-4 mx-2 my-1 first:mt-3 last:mb-3 hover:bg-base-200 rounded-xl cursor-pointer"
                >
                    <a>
                        <slot :option="o">
                        </slot>
